...
def evaluate_plan(
    ...
    New: Adds penalty for inventory exceeding max_inventory to prevent
    excessive over-ordering behavior.
    """
    ...
    for t, demand in enumerate(demands):
        ...
        if received > 0:
            cost += fixed_cost
        # NEW: Penalty for excessive inventory to prevent over-ordering
